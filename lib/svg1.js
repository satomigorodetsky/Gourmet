document.addEventListener("DOMContentLoaded", () => { 
    ...
    button0.onclick = () => { update("https://github.com/Sokada101/Gourmet/blob/master/data/total_stars.csv", "Total")}
   ...
   const yScale = d3.scaleLinear()
    ...
    update("https://github.com/Sokada101/Gourmet/blob/master/data/total_stars.csv", "Total");
